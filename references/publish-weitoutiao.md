...
```bash
# 纯文本
node {baseDir}/cli/index.js publish weitoutiao --content "今天天气真不错！\n\n分享一下午后阳光~"

# 带图片和话题
node {baseDir}/cli/index.js publish weitoutiao \
  --content "周末探店记录" \
...
# 存草稿
node {baseDir}/cli/index.js publish weitoutiao --content "草稿内容" --draft
```
